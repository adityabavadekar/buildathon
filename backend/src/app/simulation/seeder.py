...
FAILURE_TEMPLATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "category": FailureCategory.TRANSIENT_BANK_WINDOW,
        "error_code": "NB_SESSION_EXPIRED",
        "error_reason": "Net banking session expired before debit confirmation",
        "amounts": [89900, 199900, 449900, 799900],
    },
    {
        "rail": PaymentRail.NETBANKING,
        "category": FailureCategory.SYSTEMIC_GATEWAY_FAILURE,
        "error_code": "NB_BANK_UNAVAILABLE",
        "error_reason": "Sponsor bank net banking endpoint returning 5xx fleet-wide",
        "amounts": [59900, 149900, 349900],
    },
    {
        "rail": PaymentRail.UPI,
        "category": FailureCategory.SYSTEMIC_GATEWAY_FAILURE,
        "error_code": "UPI_PSP_DOWN",
        "error_reason": "PSP handle unreachable across all collect requests on the rail",
        "amounts": [24900, 69900, 159900, 329900],
    },
    {
        "rail": PaymentRail.CARD,
        "category": FailureCategory.LIQUIDITY_CONSTRAINT,
        "error_code": "CARD_LIMIT_EXCEEDED",
        "error_reason": "Card credit limit exceeded at authorization",
        "amounts": [199900, 549900, 1299900],
    },
    {
        "rail": PaymentRail.CARD,
        "category": FailureCategory.STRUCTURAL_MANDATE_FAILURE,
        "error_code": "CARD_EXPIRED",
        "error_reason": "Stored card expired before scheduled subscription renewal",
        "amounts": [49900, 129900, 299900, 599900],
    },
    {
        "rail": PaymentRail.UPI_AUTOPAY,
        "category": FailureCategory.STRUCTURAL_MANDATE_FAILURE,
        "error_code": "AP12",
        "error_reason": "Autopay mandate paused by customer at PSP app",
        "amounts": [39900, 99900, 249900],
    },
    {
        "rail": PaymentRail.ENACH,
        "category": FailureCategory.LIQUIDITY_CONSTRAINT,
        "error_code": "ENACH_INSUFFICIENT_FUNDS",
        "error_reason": "eNACH presentation returned insufficient funds on due date",
        "amounts": [199900, 499900, 1199900],
    },
    {
        "rail": PaymentRail.B2B_INVOICE,
        "category": FailureCategory.B2B_RECEIVABLES_OVERDUE,
        "error_code": "B2B_PO_MISMATCH",
        "error_reason": "Buyer finance team disputed PO amount; payment promised post-reconciliation",
        "amounts": [8000000, 18000000, 42000000],
    },
    {
        "rail": PaymentRail.UPI,
        "category": FailureCategory.CHECKOUT_DROP_OFF,
        "error_code": "UPI_COLLECT_DECLINED",
        "error_reason": "Customer declined the collect request in the PSP app",
        "amounts": [19900, 59900, 119900, 279900],
    },
]
